<template>
  <div>
    <div class="detial-right-top">
      <h2>数据预测</h2>
      <p>未来，大数据会变得越来越重要，其核心应用预测也会成为互联网行业以及产业变革的重要力量，我们很有必要对数据预测及其分析方法进行全面且深入的了解。在这一点上，《大数据预测》是本很好的读物，适合大数据所有相关行业的人阅读。</p>
      <div class="section-group">
        <div class="section-lable">购买类型:</div>
        <div class="section-main">
          <my-radio :versionList="versionList" @onchange="dosomething"></my-radio>
        </div>
      </div>
      <div class="section-group">
        <div class="section-lable">购买数量:</div>
        <div class="section-main">
